...
description: "The Flux opportunities queue combines Azure Advisor and Flux Signals findings with evidence packs, heuristic confidence scoring, provenance-aware cost valuation, and CSV/XLSX export."
---
...
| `unattached_disk` | Managed disk has no `managedBy`, is `Unattached`, and does not match ASR exclusions | Review-only; confirm retention and owner approval before deletion |
