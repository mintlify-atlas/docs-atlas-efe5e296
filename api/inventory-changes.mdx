...
description: "Azure inventory with cost and opportunity enrichment, consecutive-snapshot diffs, and change-volume anomaly baselines. Supports CSV and XLSX export."
---
