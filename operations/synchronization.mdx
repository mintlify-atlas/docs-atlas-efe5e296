---
title: "Flux Synchronization: Durable Worker Architecture"
sidebarTitle: "Synchronization"
description: "Flux uses a singleton durable sync worker to serialize DuckDB writes. Independent source schedules queue focused requests; each source checkpoint survives partial failures and worker restarts."
---
