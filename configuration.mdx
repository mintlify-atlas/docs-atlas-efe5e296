...
description: "Complete reference for every FLUX_ environment variable. Covers server, DuckDB, Azure sync, Cost Management, anomaly detection, right-sizing thresholds, telemetry, AI, and authentication settings."
---
