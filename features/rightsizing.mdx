...
description: "Each VM receives an explicit coverage state. Azure Monitor and LogicMonitor telemetry with Advisor corroboration drives idle and resize classification."
---
