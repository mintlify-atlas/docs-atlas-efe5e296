...
description: "Azure Resource Graph inventory enriched with cost and VM performance data. Snapshot drift detection flags unusual change volume using median/MAD baselines."
---
