...
description: "Ask Flux is a read-only conversational AI backed by 19 bounded server-side tools. The model never touches your database or Azure credentials — every answer traces back to a named governed tool."
---
