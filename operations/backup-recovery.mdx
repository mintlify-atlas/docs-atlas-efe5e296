---
title: "DuckDB Backup and Startup Recovery for Flux App Service"
sidebarTitle: "Backup & Recovery"
description: "Flux backs up DuckDB to Azure Blob Storage after each sync and restores the latest valid backup at startup when the database fails validation."
---
