---
title: "Flux API: Authentication, Roles, and Session Shape"
sidebarTitle: "Authentication"
description: "Auth modes (mock/entra/none), Entra Easy Auth claim decoding, Flux.Reader and Flux.Admin roles, and the GET /api/session response shape."
---
