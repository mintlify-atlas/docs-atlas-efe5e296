---
title: "Continuous Delivery with Azure Pipelines"
sidebarTitle: "CI/CD"
description: "Flux ships via Azure Pipelines using workload-identity federation. Commits to main trigger build, test, and deployment to Azure App Service — no publish profiles or secrets in the repository."
---
